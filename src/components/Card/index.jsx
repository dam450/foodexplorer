...
export function Card({ url = '#', dish, ...rest }) {
  ...
  const dishx = {
    ...
    "price": 15.97,
    "picture": "793990634b8f9ef306ee-salada.png",
    "category": "Bebidas"
  };
  ...
  return (
    <Container {...rest}>
      ...
      <div className='price-tag'>R$ {String(dish?.price.toFixed(2)).replace('.', ',')}</div>

      <div className='group'>
        <QuantityPicker value={0} defaultValue={0} setValue={null} />
